...
function renderTasks(tasks) {
    ...
    const html = tasks.map(taskTemplate).join("");// loop through the tasks array. transform (map) 
    listElement.innerHTML = html; //each task object into the appropriate HTML to represent a to-do.  
}
